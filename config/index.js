...
export const CLOUDINARY_CLOUD_NAME = "dv5vujozp";
export const CLOUDINARY_UPLOAD_PRESET = "apexadvisor";
export const CLOUDINARY_FOLDER = "apexadvisor";
...
export const DIGITALOCEAN_FOLDER = "apex-advisor";
